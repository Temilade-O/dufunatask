...
echo "<br> Quiz1<br>";
    ...
    echo "Thanks to Cotta&Cush, AHK Nigeria for this great opportunity<br><br>";
...
/*quiz 5 -Create two arrays. The first should store the first name of three people, 
the second should store respective hobbles. */
echo "<br> Quiz5<br>";
